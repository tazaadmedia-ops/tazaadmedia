    ...
    return (
        <div className="container" style={{ maxWidth: '800px', margin: '0 auto' }}>
            ...
            <div style={{ lineHeight: 1.8, fontSize: '1.1rem', color: '#333' }}>
                ...
                <p style={{ marginBottom: '1.5rem' }}>
                    اسان جو مشن سنڌي ٻوليءَ ۾ اعليٰ معيار جو صحافتي مواد فراهم ڪرڻ آهي، جيڪو عالمي معيارن سان مقابلو ڪري سگهي. اسان سياسي، سماجي، ۽ ثقافتي معاملن تي ايمانداري ۽ بي باڪي سان ڳالهائڻ ۾ يقين رکون ٿا.
                </p>
            </div>
        </div>
    );
